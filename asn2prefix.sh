...
html2text asn*.html | grep -oE "\b([0-9]{1,3}\.){3}[0-9]{1,2}/[0-9]{1,2}\b" > ../bdix-prefix_ipv4.txt
html2text asn*.html | grep -oE "\b([0-9a-fA-F:]+:+)+(:[0-9a-fA-F]+)?/[0-9]{1,3}\b" > ../bdix-prefix_ipv6.txt
